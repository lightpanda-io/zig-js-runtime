...
build:
	...
	@zig build bench -Dengine=quickjs || (printf "\e[33mBuild ERROR\e[0m\n"; exit 1;)
	@printf "\e[33mBuild OK\e[0m\n"

build-release:
	@printf "\e[36mBuilding (release safe)...\e[0m\n"
	@zig build -Drelease-safe -Dengine=quickjs || (printf "\e[33mBuild ERROR\e[0m\n"; exit 1;)
	@printf "\e[33mBuild OK\e[0m\n"
...
shell:
	...
	@zig build shell -Dengine=quickjs || (printf "\e[33mBuild ERROR\e[0m\n"; exit 1;)

## Test
test:
	@printf "\e[36mTesting...\e[0m\n"
	@zig build test -Dengine=quickjs || (printf "\e[33mTest ERROR\e[0m\n"; exit 1;)
